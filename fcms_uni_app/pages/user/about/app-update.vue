        ...
        <view class="popup-bg">
          <view class="popup-content" :class="{'popup-content-show' : popup_show}">
            <view class="update-wrap">
              <image src="@/static/update_app/img.png" class="top-img"></image>
              <view class="content">
            ...
            <image src="@/static/update_app/close.png" class="close-ioc" @click="closeUpdate()" v-if="downstatus < 1 && update_info.force == 0"></image>
          </view>
        </view>
      </view>
    </view>
...
export default {
  ...
  onLoad(option) {
    if (option.query) {
      let obj = JSON.parse(option.query)
      this.update_info = JSON.parse(obj.updata_info)
      console.log(obj.updata_info)
      console.log(this.update_info.note)
...
.sche-wrap {
  ...
  .sche-bg {
    ...
    .sche-bg-jindu {
      ...
      min-width: 40rpx;
      border-radius: 100px;
      background: url(@/static/update_app/round.png) #5775e7 center right 4rpx no-repeat;
